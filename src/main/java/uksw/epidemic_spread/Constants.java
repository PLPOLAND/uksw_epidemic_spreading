...
public class Constants {
    ...
    public static final boolean AKA_MANHATTAN_MOBILITY_MODEL = false;
    
    
    public static final int SIZE_OF_ARMY = 200;
    ...
    public static final long TIME_OF_EXPERIMENT = 180 * SECOND;
